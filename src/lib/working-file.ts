 ...
 * open different files even when basenames match (e.g. et2-board.json).
 */
...
export const STANDARD_WORKING_FILENAME = "et2-board.json";
 ...
 * Never fall back to basename equality — two `et2-board.json` in different
...
export function userFacingFileReadError(error: unknown): string {
  ...
  if (
    ...
    return [
      ...
      "2. In ET2 die Datei aus „Downloads“ oder „Dateien auf diesem Gerät“ wählen — nicht aus dem Proton-Drive-Eintrag",
      "",
