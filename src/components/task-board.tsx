...
export function TaskBoard() {
  ...
  const appHeader = (
    <header className="shrink-0 border-b border-[var(--border)] bg-[var(--panel-solid)]">
      <div className="flex items-center gap-2 px-3 py-2 sm:gap-3 sm:px-4">
        <div className="flex shrink-0 items-center gap-1.5">
          <h1 className="text-sm font-semibold tracking-tight text-[var(--text)]">ET2</h1>
          <BetaBadge />
        </div>
  ...
  return (
    <div className="relative flex h-screen min-h-0 flex-col overflow-hidden bg-[var(--bg)] text-[var(--text)]">
      ...
      <JsonPasteImportDialog
        ...
        hint="JSON-Inhalt Ihrer et2-board.json hier einfügen (z. B. vom PC kopiert). Nur Board-JSON (scope „board“)."
