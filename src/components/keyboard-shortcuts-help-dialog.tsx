  ...
  const sections: ShortcutSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { keys: "Shift + →", description: "Eine Ebene tiefer (nur unter eine aufgeklappte Karte darüber)" },
    ...
    },
    {
      ...
      hint: "Karte zuerst per Klick oder Pfeiltasten fokussieren (blauer Rand). „Tasten“ oben rechts erklärt die Kürzel.",
      items: [
        ...
        { keys: "Shift + →", description: "Karte eine Ebene tiefer (nur unter eine aufgeklappte Karte darüber)" },
